...
-- ----------------------------
-- Primary Key structure for table aplicationjobs
-- ----------------------------
ALTER TABLE "public"."aplicationjobs" ADD PRIMARY KEY ("id");
...
-- ----------------------------
ALTER TABLE "public"."authorizations" ADD PRIMARY KEY ("id");
...
-- ----------------------------
-- Primary Key structure for table m_countries
-- ----------------------------
ALTER TABLE "public"."m_countries" ADD PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table messageemployees
-- ----------------------------
ALTER TABLE "public"."messageemployees" ADD PRIMARY KEY ("id");
...
-- ----------------------------
-- Primary Key structure for table userfacebooks
-- ----------------------------
ALTER TABLE "public"."userfacebooks" ADD PRIMARY KEY ("id");
