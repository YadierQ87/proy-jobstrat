...
ActiveRecord::Schema.define(version: 20170928181545) do
  ...
  create_table "aplicationjobs", force: :cascade do |t|
    ...
    t.index ["job_id", "employee_id"], name: "index_aplicationjobs_on_job_id_and_employee_id", unique: true, using: :btree
